...
export const products = [
  ...
  },
  {
    ...
    name: 'Free Fire Max',
    category: '1',
    image: '/gassets/product/free-fire-max.webp',
    popular: false,
    discount: '',
    inputLabel: 'Masukkan Player ID',
    inputFields: [
  ...
  },
  {
    ...
    name: 'Pubg Mobile',
    category: '1',
    image: '/gassets/product/pubg-mobile.webp',
    popular: true,
    discount: '',
  ...
  },
  {
    ...
    name: 'Genshin Impact',
    category: '1',
    image: '/gassets/product/genshin-impact.webp',
    popular: false,
    discount: '',
  ...
  },
  {
    ...
    category: '1',
    image: '/gassets/product/haikyu.webp',
    popular: false,
    discount: '',
    inputLabel: 'Masukkan Player ID',
    inputFields: [
  ...
  },
  {
    ...
    category: '1',
    image: '/gassets/product/state-of-survival.webp',
    popular: true,
    discount: '',
  ...
  },
  {
    ...
    name: 'Koin Ungu Md',
    category: '1',
    image: '/gassets/product/koin-ungu-md.webp',
    popular: true,
    discount: '',
    inputLabel: 'Masukkan Player ID',
    inputFields: [
  ...
  },
  {
    ...
    name: 'Honor of Kings',
    category: '1',
    image: '/gassets/product/honor-of-kings.webp',
    popular: true,
    discount: '',
    inputLabel: 'Masukkan Player ID',
    inputFields: [
  ...
  },
  {
    ...
    name: 'Racing Master',
    category: '1',
    image: '/gassets/product/racing-master.webp',
    popular: true,
    discount: '',
    inputLabel: 'Masukkan Player ID',
    inputFields: [
  ...
  // Voucher games
  {
    ...
    category: '2',
    image: '/gassets/product/rf-return.webp',
    popular: true,
    discount: '',
  ...
  // Entertainment
  {
    ...
    category: '3',
    image: '/gassets/product/netflix.webp',
    popular: true,
    discount: '',
...
export const paymentChannels = [
  {
    ...
    category: 'QRIS',
    name: 'QRIS',
    image: '/gassets/payment/qris.svg',
    feePercent: 0.007,
    feeFlat: 0
  },
  {
    ...
    category: 'E-Wallet',
    name: 'DANA',
    image: '/gassets/payment/dana.svg',
    feePercent: 0,
    feeFlat: 1500
  },
  {
    ...
    category: 'E-Wallet',
    name: 'GoPay',
    image: '/gassets/payment/gopay.svg',
    feePercent: 0.02,
    feeFlat: 0
  },
  {
  ...
  },
  {
    ...
    category: 'E-Wallet',
    name: 'ShopeePay',
    image: '/gassets/payment/shopeepay.svg',
    feePercent: 0.01,
    feeFlat: 0
  },
  {
    ...
    category: 'E-Wallet',
    name: 'LinkAja',
    image: '/gassets/payment/linkaja.svg',
    feePercent: 0.01,
    feeFlat: 0
  },
  {
  ...
  },
  {
    ...
    image: '/gassets/payment/mandiri.svg',
    feePercent: 0,
    feeFlat: 2000
  },
  {
  ...
  },
  {
    ...
    image: '/gassets/payment/cimb.svg',
    feePercent: 0,
    feeFlat: 2000
  },
  {
    ...
    image: '/gassets/payment/permatabank.svg',
    feePercent: 0,
    feeFlat: 2000
  },
  {
    ...
    category: 'Retail',
    name: 'Alfamart',
    image: '/gassets/payment/alfamart.svg',
    feePercent: 0,
    feeFlat: 3500
  },
  {
    ...
    category: 'Retail',
    name: 'Indomaret',
    image: '/gassets/payment/indomaret.svg',
    feePercent: 0,
    feeFlat: 3500
  }
];
